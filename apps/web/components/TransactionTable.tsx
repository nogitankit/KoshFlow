...
export default function TransactionTable({transactions}: TransactionTableProps){
  return(
    ...
    <TableHeader className="bg-slate-900/50">
      ...
      <TableHead className="px-2 max-md:hidden text-slate-400 text-[11px] uppercase tracking-wider font-semibold">Channel</TableHead>
      ...
      transactions.map((t: Transaction, index: number) => {
        ...
        return (
          <TableRow key={t.id} className={
            clsx('border-b border-white/5 transition-all duration-200 group cursor-default', {
          ...
          >
            ...
            <TableCell className="capitalize min-w-24 pl-2 pr-10 text-slate-400 text-[13px]">
              {t.paymentChannel}
            </TableCell>
